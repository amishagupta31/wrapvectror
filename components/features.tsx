...
const defaultContent: FeaturesContent = {
  ...
  subtitle: "Discover our practical approach to automation and product development",
}
    ...
    <section id="features" className="container mx-auto px-4 py-16 sm:py-20">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card className="hidden md:block liquid-glass border border-white/20">
          <CardHeader>
            <p className="text-[11px] tracking-widest text-white/80">CAPABILITY</p>
            <CardTitle className="mt-1 text-xl text-white">Build systems that feel effortless</CardTitle>
          </CardHeader>
          <CardContent>
        ...
        <Card className="liquid-glass border border-white/20">
          <CardHeader>
            <p className="text-[11px] tracking-widest text-white/80">CLIENT RESULTS</p>
            <CardTitle className="mt-1 text-xl text-white">
              We combine strategy, design, and engineering to create products people love to use.
            </CardTitle>
          </CardHeader>
          <CardContent>
            <div className="mb-6 flex items-end gap-4">
              <div className="text-5xl font-bold text-blue-300">4.9</div>
              <div className="flex items-center gap-1">
                {Array.from({ length: 5 }).map((_, i) => (
                  <Star key={i} className="h-5 w-5 fill-blue-300 text-blue-300" />
                ))}
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
