...
export function TechStack() {
  ...
  return (
    <section id="tech" className="relative py-28 sm:py-36 overflow-hidden bg-black/60 scroll-mt-20">
      ...
      <div className="container mx-auto px-4 max-w-6xl relative z-10">
        ...
        <div className="rounded-3xl p-8 sm:p-12 bg-zinc-950/90 border border-white/10 shadow-[0_15px_60px_rgba(0,0,0,0.6)] backdrop-blur-2xl">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pb-6 border-b border-white/10 mb-8 gap-3">
            ...
            <div className="text-xs font-mono text-blue-400/80 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {active.techs.map((tech) => (
              <div
                key={tech.name}
                className="p-5 rounded-2xl bg-white/[0.02] border border-white/10 hover:border-blue-500/40 hover:bg-white/[0.04] transition-all duration-200 group"
              >
